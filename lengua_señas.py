...
def draw_bounding_box(image, hand_landmarks):
    ...
    # Iterar a través de los puntos de referencia para encontrar las coordenadas del cuadro delimitador
...
# Capturar video
cap = cv2.VideoCapture(0)  # Cambia el índice de la cámara si es necesario
cap.set(3, 1920)
cap.set(4, 1080)
        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                for num, hand_landmarks in enumerate(results.multi_hand_landmarks):
                    ...
                    # Obtener las coordenadas de las marcas importantes
            ...
            key = cv2.waitKey(5)
            if key == 27 or key == 13:  # Presiona 'Esc' o 'Enter' para salir
                break
